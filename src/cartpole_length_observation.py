...
class CartPoleEnv(gym.Env):
    ...
    def step(self, action):
        ...
        x, x_dot, theta, theta_dot, _ = self.state  # _ = self.length
        ...
        self.state = (x, x_dot, theta, theta_dot, self.length)
    ...
    def reset(self):
        self.state = np.concatenate([self.np_random.uniform(low=-0.05, high=0.05, size=(4,)) + [self.length]])
        self.steps_beyond_done = None
